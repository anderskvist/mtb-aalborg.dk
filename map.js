...
function initMap() {
	...
	const url = "https://boligejer.dk/ejendomsdata/0/10/0/" + 
	      event.feature.l.esrejendomsnr +
	      "%7C" + 
	      event.feature.l.udvidet_esrejendomsnr.substring(0, 3).padStart(4, '0');

	infowindow.setContent("<a href='" + url + "' target='_blank'>link</a> - " + event.feature.l.udvidet_esrejendomsnr); // show the html variable in the infowindow
